...
const ProfileCard = () => {
  ...
  const handleSave = () => {
    ...
    // Setelah berhasil menyimpan, ubah activeTab ke 'detail'
    setActiveTab('detail');
  };
      ...
      <div className="flex flex-col lg:flex-row">
        <div className="w-full lg:w-1/3 p-4 lg:p-6">
          <div className= "bg-white rounded-lg shadow-md p-4 lg:p-6 border">
            ...
            <div className="p-6 border-gray-200 lg:pr-6"> {/* Menambahkan padding kanan untuk jarak */}
             ...
             <div className="flex items-center flex-col">
                <h1 className="text-xl font-bold p-4 text-center">{profileData.nama}</h1>
        ...
        <div className="pl-8 bg-white rounded-lg shadow-md p-4 lg:p-6 border ">
          <ul className="flex my-4 space-x-6">
            <li>
            <button
              className={`text-blue-500 hover:underline ${activeTab === 'detail' ? 'font-bold' : ''}`}
            ...
            <li>
            <button
              className={`text-blue-500 hover:underline ${activeTab === 'edit' ? 'font-bold' : ''}`}
            ...
            <li>
            <button
              className={`text-blue-500 hover:underline ${activeTab === 'ubah' ? 'font-bold' : ''}`}
          ...
          {activeTab === 'detail' && (
            <div>
              ...
              <ul className="list-disc space-y-6">
                ...
                <li className="flex flex-col sm:flex-row sm:items-center">
                  <span className="text-gray-400 sm:w-60 sm:mr-4">Alamat</span>
                  <span>{profileData.alamat}</span>
                </li>
                <li className="flex flex-col sm:flex-row sm:items-center">
                  <span className="text-gray-400 sm:w-60 sm:mr-4">Jenis Kelamin</span>
                  <span>{profileData.jenisKelamin}</span>
                </li>
                <li className="flex flex-col sm:flex-row sm:items-center">
                  <span className="text-gray-400 sm:w-60 sm:mr-4">Nomor Telepon</span>
          ...
          {activeTab === 'edit' && (
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center items-start mb-4">
                <span className="lg:w-48 sm:w-52 block text-gray-400 mb-2 lg:-mt-32 md:-mt-32 sm:-mt-0 ">Profile Image</span>
              ...
              <p className="flex flex-col sm:flex-row sm:items-center">
                ...
                <p className="flex flex-col sm:flex-row sm:items-center">
                  <span className="w-80 text-gray-400 lg:-mt-24 md:-mt-24 sm:-mt-0">Tentang</span>
                  <textarea
                    name="tentang"
          ...
          {activeTab === 'ubah' && (
            <div>
              ...
              <div className="space-y-4">
                  <div>
                    <label className="block text-gray-600 mb-1" htmlFor="oldPassword">
                      Password Lama
                    </label>
                    <input
                      type="password"
